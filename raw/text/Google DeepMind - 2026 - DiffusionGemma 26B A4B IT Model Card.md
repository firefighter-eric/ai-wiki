...
- Source HTML: `raw/html/Google DeepMind - 2026 - DiffusionGemma 26B A4B IT Model Card.html`
- Source URL: https://huggingface.co/google/diffusiongemma-26B-A4B-it
...
## Model tree for google/diffusiongemma-26B-A4B-it

Quantizations

## Spaces using google/diffusiongemma-26B-A4B-it 2
...
Mike0021/diffusiongemma-26b-a4b-it

## Collection including google/diffusiongemma-26B-A4B-it

#### DiffusionGemma

Collection

1 item • Updated about 1 hour ago • 6
