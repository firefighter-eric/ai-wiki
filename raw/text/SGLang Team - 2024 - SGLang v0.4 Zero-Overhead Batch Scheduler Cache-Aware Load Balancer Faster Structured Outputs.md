...
- Source HTML: `raw/html/SGLang Team - 2024 - SGLang v0.4 Zero-Overhead Batch Scheduler Cache-Aware Load Balancer Faster Structured Outputs.html`
...
The SGLang TeamDecember 4, 2024
...
SGLang v0.3SGLang v0.4

Throughput (token/s)82665158596
...
You can then query it with the OpenAI-compatible API. See an example at https://sgl-project.github.io/backend/openai_api_completions.html#JSON.
...
It has been a great year, and we delivered many features following our roadmap.
