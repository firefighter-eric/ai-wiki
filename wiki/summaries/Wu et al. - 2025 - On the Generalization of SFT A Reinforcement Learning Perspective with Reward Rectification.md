...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Wu et al. - 2025 - On the Generalization of SFT A Reinforcement Learning Perspective with Reward Rectification.pdf
- 全文文本：../../raw/text/Wu et al. - 2025 - On the Generalization of SFT A Reinforcement Learning Perspective with Reward Rectification.md
- 作者：Wu et al.
- 年份：2025
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Wu et al. - 2025 - On the Generalization of SFT A Reinforcement Learning Perspective with Reward Rectification.md` 继续做深入整理。
