...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Li et al. - 2023 - TrOCR Transformer-Based Optical Character Recognition with Pre-trained Models.pdf
- 全文文本：../../raw/text/Li et al. - 2023 - TrOCR Transformer-Based Optical Character Recognition with Pre-trained Models.md
- 作者：Li et al.
- 年份：2023
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Li et al. - 2023 - TrOCR Transformer-Based Optical Character Recognition with Pre-trained Models.md` 继续做深入整理。
