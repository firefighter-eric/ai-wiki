...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Devlin et al. - 2019 - BERT Pre-training of deep bidirectional transformers for language understanding.pdf
- 全文文本：../../raw/text/Devlin et al. - 2019 - BERT Pre-training of deep bidirectional transformers for language understanding.md
- 作者：Devlin et al.
- 年份：2019
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Devlin et al. - 2019 - BERT Pre-training of deep bidirectional transformers for language understanding.md` 继续做深入整理。
