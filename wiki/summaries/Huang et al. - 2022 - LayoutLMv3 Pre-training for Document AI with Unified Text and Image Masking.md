...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Huang et al. - 2022 - LayoutLMv3 Pre-training for Document AI with Unified Text and Image Masking.pdf
- 全文文本：../../raw/text/Huang et al. - 2022 - LayoutLMv3 Pre-training for Document AI with Unified Text and Image Masking.md
- 作者：Huang et al.
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Huang et al. - 2022 - LayoutLMv3 Pre-training for Document AI with Unified Text and Image Masking.md` 继续做深入整理。
