...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Sun et al. - 2023 - A Comparative Study between Full-Parameter and LoRA-based Fine-Tuning on Chinese Instruction Data for Instruction Fo.pdf
- 全文文本：../../raw/text/Sun et al. - 2023 - A Comparative Study between Full-Parameter and LoRA-based Fine-Tuning on Chinese Instruction Data for Instruction Fo.md
- 作者：Sun et al.
- 年份：2023
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Sun et al. - 2023 - A Comparative Study between Full-Parameter and LoRA-based Fine-Tuning on Chinese Instruction Data for Instruction Fo.md` 继续做深入整理。
