...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Chen et al. - 2020 - What comprises a good talking-head video generation A Survey and Benchmark.pdf
- 全文文本：../../raw/text/Chen et al. - 2020 - What comprises a good talking-head video generation A Survey and Benchmark.md
- 作者：Chen et al.
- 年份：2020
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Chen et al. - 2020 - What comprises a good talking-head video generation A Survey and Benchmark.md` 继续做深入整理。
