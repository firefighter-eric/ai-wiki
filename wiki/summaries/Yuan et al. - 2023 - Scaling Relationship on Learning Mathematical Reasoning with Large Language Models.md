...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Yuan et al. - 2023 - Scaling Relationship on Learning Mathematical Reasoning with Large Language Models.pdf
- 全文文本：../../raw/text/Yuan et al. - 2023 - Scaling Relationship on Learning Mathematical Reasoning with Large Language Models.md
- 作者：Yuan et al.
- 年份：2023
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Yuan et al. - 2023 - Scaling Relationship on Learning Mathematical Reasoning with Large Language Models.md` 继续做深入整理。
