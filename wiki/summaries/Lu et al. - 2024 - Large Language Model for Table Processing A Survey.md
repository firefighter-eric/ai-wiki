...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Lu et al. - 2024 - Large Language Model for Table Processing A Survey.pdf
- 全文文本：../../raw/text/Lu et al. - 2024 - Large Language Model for Table Processing A Survey.md
- 作者：Lu et al.
- 年份：2024
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Lu et al. - 2024 - Large Language Model for Table Processing A Survey.md` 继续做深入整理。
