...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Yao et al. - 2021 - NLP From Scratch Without Large-Scale Pretraining A Simple and Efficient Framework.pdf
- 全文文本：../../raw/text/Yao et al. - 2021 - NLP From Scratch Without Large-Scale Pretraining A Simple and Efficient Framework.md
- 作者：Yao et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Yao et al. - 2021 - NLP From Scratch Without Large-Scale Pretraining A Simple and Efficient Framework.md` 继续做深入整理。
