...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Pang et al. - 2022 - Long Document Summarization with Top-down and Bottom-up Inference.pdf
- 全文文本：../../raw/text/Pang et al. - 2022 - Long Document Summarization with Top-down and Bottom-up Inference.md
- 作者：Pang et al.
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Pang et al. - 2022 - Long Document Summarization with Top-down and Bottom-up Inference.md` 继续做深入整理。
