...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Fang et al. - 2021 - Injecting Semantic Concepts into End-to-End Image Captioning.pdf
- 全文文本：../../raw/text/Fang et al. - 2021 - Injecting Semantic Concepts into End-to-End Image Captioning.md
- 作者：Fang et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Fang et al. - 2021 - Injecting Semantic Concepts into End-to-End Image Captioning.md` 继续做深入整理。
