...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Mikolov et al. - 2013 - Efficient estimation of word representations in vector space.pdf
- 全文文本：../../raw/text/Mikolov et al. - 2013 - Efficient estimation of word representations in vector space.md
- 作者：Mikolov et al.
- 年份：2013
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Mikolov et al. - 2013 - Efficient estimation of word representations in vector space.md` 继续做深入整理。
