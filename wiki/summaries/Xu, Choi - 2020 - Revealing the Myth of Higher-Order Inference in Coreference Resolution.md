...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Xu, Choi - 2020 - Revealing the Myth of Higher-Order Inference in Coreference Resolution.pdf
- 全文文本：../../raw/text/Xu, Choi - 2020 - Revealing the Myth of Higher-Order Inference in Coreference Resolution.md
- 作者：Xu, Choi
- 年份：2020
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Xu, Choi - 2020 - Revealing the Myth of Higher-Order Inference in Coreference Resolution.md` 继续做深入整理。
