...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Xing et al. - 2023 - LORE Logical Location Regression Network for Table Structure Recognition.pdf
- 全文文本：../../raw/text/Xing et al. - 2023 - LORE Logical Location Regression Network for Table Structure Recognition.md
- 作者：Xing et al.
- 年份：2023
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Xing et al. - 2023 - LORE Logical Location Regression Network for Table Structure Recognition.md` 继续做深入整理。
