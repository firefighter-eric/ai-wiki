...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Liu - 2019 - Fine-tune BERT for Extractive Summarization.pdf
- 全文文本：../../raw/text/Liu - 2019 - Fine-tune BERT for Extractive Summarization.md
- 作者：Liu
- 年份：2019
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Liu - 2019 - Fine-tune BERT for Extractive Summarization.md` 继续做深入整理。
