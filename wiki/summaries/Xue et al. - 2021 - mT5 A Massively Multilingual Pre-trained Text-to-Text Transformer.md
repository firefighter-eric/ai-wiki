...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Xue et al. - 2021 - mT5 A Massively Multilingual Pre-trained Text-to-Text Transformer.pdf
- 全文文本：../../raw/text/Xue et al. - 2021 - mT5 A Massively Multilingual Pre-trained Text-to-Text Transformer.md
- 作者：Xue et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Xue et al. - 2021 - mT5 A Massively Multilingual Pre-trained Text-to-Text Transformer.md` 继续做深入整理。
