...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Hoffmann et al. - 2022 - Training Compute-Optimal Large Language Models.pdf
- 全文文本：../../raw/text/Hoffmann et al. - 2022 - Training Compute-Optimal Large Language Models.md
- 作者：Hoffmann et al.
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Hoffmann et al. - 2022 - Training Compute-Optimal Large Language Models.md` 继续做深入整理。
