...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Zheng et al. - 2025 - PPTAgent Generating and Evaluating Presentations Beyond Text-to-Slides.pdf
- 全文文本：../../raw/text/Zheng et al. - 2025 - PPTAgent Generating and Evaluating Presentations Beyond Text-to-Slides.md
- 作者：Zheng et al.
- 年份：2025
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Zheng et al. - 2025 - PPTAgent Generating and Evaluating Presentations Beyond Text-to-Slides.md` 继续做深入整理。
