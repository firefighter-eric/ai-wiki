...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Qiu et al. - 2020 - Pre-trained models for natural language processing A survey.pdf
- 全文文本：../../raw/text/Qiu et al. - 2020 - Pre-trained models for natural language processing A survey.md
- 作者：Qiu et al.
- 年份：2020
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Qiu et al. - 2020 - Pre-trained models for natural language processing A survey.md` 继续做深入整理。
