...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Wang et al. - 2022 - HPT Hierarchy-aware Prompt Tuning for Hierarchical Text Classification.pdf
- 全文文本：../../raw/text/Wang et al. - 2022 - HPT Hierarchy-aware Prompt Tuning for Hierarchical Text Classification.md
- 作者：Wang et al.
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Wang et al. - 2022 - HPT Hierarchy-aware Prompt Tuning for Hierarchical Text Classification.md` 继续做深入整理。
