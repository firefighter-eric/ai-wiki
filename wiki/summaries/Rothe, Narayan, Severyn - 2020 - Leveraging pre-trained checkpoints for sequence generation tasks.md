...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Rothe, Narayan, Severyn - 2020 - Leveraging pre-trained checkpoints for sequence generation tasks.pdf
- 全文文本：../../raw/text/Rothe, Narayan, Severyn - 2020 - Leveraging pre-trained checkpoints for sequence generation tasks.md
...
- 已存在可读全文文本，可直接从 `raw/text/Rothe, Narayan, Severyn - 2020 - Leveraging pre-trained checkpoints for sequence generation tasks.md` 继续做深入整理。
