...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Jiang, Wang - 2022 - Deep Continuous Prompt for Contrastive Learning of Sentence Embeddings.pdf
- 全文文本：../../raw/text/Jiang, Wang - 2022 - Deep Continuous Prompt for Contrastive Learning of Sentence Embeddings.md
- 作者：Jiang, Wang
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Jiang, Wang - 2022 - Deep Continuous Prompt for Contrastive Learning of Sentence Embeddings.md` 继续做深入整理。
