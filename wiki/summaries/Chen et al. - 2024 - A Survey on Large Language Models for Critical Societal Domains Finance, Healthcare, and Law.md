...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Chen et al. - 2024 - A Survey on Large Language Models for Critical Societal Domains Finance, Healthcare, and Law.pdf
- 全文文本：../../raw/text/Chen et al. - 2024 - A Survey on Large Language Models for Critical Societal Domains Finance, Healthcare, and Law.md
- 作者：Chen et al.
- 年份：2024
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Chen et al. - 2024 - A Survey on Large Language Models for Critical Societal Domains Finance, Healthcare, and Law.md` 继续做深入整理。
