...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Zhang et al. - 2025 - SlideAudit A Dataset and Taxonomy for Automated Evaluation of Presentation Slides.pdf
- 全文文本：../../raw/text/Zhang et al. - 2025 - SlideAudit A Dataset and Taxonomy for Automated Evaluation of Presentation Slides.md
- 作者：Zhang et al.
- 年份：2025
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Zhang et al. - 2025 - SlideAudit A Dataset and Taxonomy for Automated Evaluation of Presentation Slides.md` 继续做深入整理。
