...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Tschannen et al. - 2025 - SigLIP 2 Multilingual Vision-Language Encoders with Improved Semantic Understanding , Localization , and Dens.pdf
- 全文文本：../../raw/text/Tschannen et al. - 2025 - SigLIP 2 Multilingual Vision-Language Encoders with Improved Semantic Understanding , Localization , and Dens.md
- 作者：Tschannen et al.
- 年份：2025
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Tschannen et al. - 2025 - SigLIP 2 Multilingual Vision-Language Encoders with Improved Semantic Understanding , Localization , and Dens.md` 继续做深入整理。
