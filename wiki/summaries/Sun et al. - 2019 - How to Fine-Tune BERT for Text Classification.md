...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Sun et al. - 2019 - How to Fine-Tune BERT for Text Classification.pdf
- 全文文本：../../raw/text/Sun et al. - 2019 - How to Fine-Tune BERT for Text Classification.md
- 作者：Sun et al.
- 年份：2019
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Sun et al. - 2019 - How to Fine-Tune BERT for Text Classification.md` 继续做深入整理。
