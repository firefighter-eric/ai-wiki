...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/OpenAI et al. - 2019 - Dota 2 with Large Scale Deep Reinforcement Learning.pdf
- 全文文本：../../raw/text/OpenAI et al. - 2019 - Dota 2 with Large Scale Deep Reinforcement Learning.md
- 作者：OpenAI et al.
- 年份：2019
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/OpenAI et al. - 2019 - Dota 2 with Large Scale Deep Reinforcement Learning.md` 继续做深入整理。
