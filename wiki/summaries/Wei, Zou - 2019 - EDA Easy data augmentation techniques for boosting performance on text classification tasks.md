...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Wei, Zou - 2019 - EDA Easy data augmentation techniques for boosting performance on text classification tasks.pdf
- 全文文本：../../raw/text/Wei, Zou - 2019 - EDA Easy data augmentation techniques for boosting performance on text classification tasks.md
- 作者：Wei, Zou
- 年份：2019
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Wei, Zou - 2019 - EDA Easy data augmentation techniques for boosting performance on text classification tasks.md` 继续做深入整理。
