...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Su et al. - 2021 - Whitening Sentence Representations for Better Semantics and Faster Retrieval.pdf
- 全文文本：../../raw/text/Su et al. - 2021 - Whitening Sentence Representations for Better Semantics and Faster Retrieval.md
- 作者：Su et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Su et al. - 2021 - Whitening Sentence Representations for Better Semantics and Faster Retrieval.md` 继续做深入整理。
