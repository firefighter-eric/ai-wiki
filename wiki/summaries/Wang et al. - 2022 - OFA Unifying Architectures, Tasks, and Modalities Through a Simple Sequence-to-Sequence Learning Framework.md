...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Wang et al. - 2022 - OFA Unifying Architectures, Tasks, and Modalities Through a Simple Sequence-to-Sequence Learning Framework.pdf
- 全文文本：../../raw/text/Wang et al. - 2022 - OFA Unifying Architectures, Tasks, and Modalities Through a Simple Sequence-to-Sequence Learning Framework.md
- 作者：Wang et al.
- 年份：2022
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Wang et al. - 2022 - OFA Unifying Architectures, Tasks, and Modalities Through a Simple Sequence-to-Sequence Learning Framework.md` 继续做深入整理。
