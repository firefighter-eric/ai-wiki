...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Smock, Pesala, Abraham - 2023 - Aligning Benchmark Datasets for Table Structure Recognition.pdf
- 全文文本：../../raw/text/Smock, Pesala, Abraham - 2023 - Aligning Benchmark Datasets for Table Structure Recognition.md
...
- 已存在可读全文文本，可直接从 `raw/text/Smock, Pesala, Abraham - 2023 - Aligning Benchmark Datasets for Table Structure Recognition.md` 继续做深入整理。
