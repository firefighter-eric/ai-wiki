...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Sciavolino et al. - 2021 - Simple Entity-Centric Questions Challenge Dense Retrievers.pdf
- 全文文本：../../raw/text/Sciavolino et al. - 2021 - Simple Entity-Centric Questions Challenge Dense Retrievers.md
- 作者：Sciavolino et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Sciavolino et al. - 2021 - Simple Entity-Centric Questions Challenge Dense Retrievers.md` 继续做深入整理。
