...
- 类型：论文 / 技术报告
- 原始文件：../../raw/pdf/Yan et al. - 2021 - ConSERT A contrastive framework for self-supervised sentence representation transfer.pdf
- 全文文本：../../raw/text/Yan et al. - 2021 - ConSERT A contrastive framework for self-supervised sentence representation transfer.md
- 作者：Yan et al.
- 年份：2021
- 状态：已抽取全文，待精读
...
- 已存在可读全文文本，可直接从 `raw/text/Yan et al. - 2021 - ConSERT A contrastive framework for self-supervised sentence representation transfer.md` 继续做深入整理。
